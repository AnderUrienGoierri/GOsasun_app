...
{
    public partial class EskuzkoNeurketaFormularioa : OinarriFormularioa
    {
        ...
        public EskuzkoNeurketaFormularioa(Erabiltzailea erabiltzailea, bool isPisua) : base(erabiltzailea)
        {
            InitializeComponent();
