...
namespace GOsasun_app.Interfazea
{
    partial class MedikuMenua
    {
        ...
        private void InitializeComponent()
        {
            ...
            btnPazienteak = new GOsasun_app.Interfazea.Kontrolak.CustomCardButton();
            btnKontaktua = new GOsasun_app.Interfazea.Kontrolak.CustomCardButton();
            btnNeurketak = new GOsasun_app.Interfazea.Kontrolak.CustomCardButton();
            btnErrezetak = new GOsasun_app.Interfazea.Kontrolak.CustomCardButton();
            btnGrafikak = new GOsasun_app.Interfazea.Kontrolak.CustomCardButton();
            btnAbisuak = new GOsasun_app.Interfazea.Kontrolak.CustomCardButton();
        ...
        private GOsasun_app.Interfazea.Kontrolak.CustomCardButton btnPazienteak;
        private GOsasun_app.Interfazea.Kontrolak.CustomCardButton btnKontaktua;
        private GOsasun_app.Interfazea.Kontrolak.CustomCardButton btnNeurketak;
        private GOsasun_app.Interfazea.Kontrolak.CustomCardButton btnErrezetak;
        private GOsasun_app.Interfazea.Kontrolak.CustomCardButton btnGrafikak;
        private GOsasun_app.Interfazea.Kontrolak.CustomCardButton btnAbisuak;
    }
}
