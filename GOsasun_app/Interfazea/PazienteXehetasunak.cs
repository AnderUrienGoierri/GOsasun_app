...
namespace GOsasun_app.Interfazea
{
    ...
    /// </summary>
    public partial class PazienteXehetasunak : GoiburuPanela
    {
        private readonly Pazientea _pazientea;

        public PazienteXehetasunak(Pazientea pazientea)
            : base() // Ez dugu medikuaren info goiburuan behar, edo agian bai? 
                     // GoiburuPanela(erabiltzailea) deituko dugu medikuaren izena goiburuan mantentzeko baldin badugu.
        {
