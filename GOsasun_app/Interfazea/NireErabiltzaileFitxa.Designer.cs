...
{
    partial class NireErabiltzaileFitxa
    {
        ...
        private void InitializeComponent()
        {
            ...
            lblErabiltzaileMotaTitulua = new Label();
            lblErabiltzaileMotaBalioa = new Label();
            ...
            pnlRolPanela = new Panel();
            lblRolDatuak = new Label();
            pnlKontua = new Panel();
            lblKontua = new Label();
            lblIdTitulua = new Label();
            lblIdBalioa = new Label();
            lblRolIdTitulua = new Label();
            lblRolIdBalioa = new Label();
            lblAltaDataTitulua = new Label();
            lblAltaDataBalioa = new Label();
            ...
            pnlRolPanela.SuspendLayout();
            pnlKontua.SuspendLayout();
            SuspendLayout();
            //
            // _edukiPanela
            //
            _edukiPanela.Controls.Add(pnlKontua);
            _edukiPanela.Controls.Add(pnlRolPanela);
            ...
            pnlGoiburua.Controls.Add(lblRolBadge);
            ...
            lblIzena.Size = new Size(980, 82);
            lblIzena.TabIndex = 1;
            lblIzena.Text = "Erabiltzailearen izen-abizenak";
            //
            // lblAzpiInformazioa
            //
            ...
            lblAzpiInformazioa.Size = new Size(1114, 64);
            lblAzpiInformazioa.TabIndex = 2;
            lblAzpiInformazioa.Text = "Rola | emaila | alta data";
            //
            // lblRolBadge
            //
            lblRolBadge.BackColor = Color.FromArgb(226, 239, 252);
            lblRolBadge.Font = new Font("Segoe UI", 11F, FontStyle.Bold);
            lblRolBadge.ForeColor = Color.FromArgb(44, 93, 140);
            lblRolBadge.Location = new Point(1522, 15);
            lblRolBadge.Name = "lblRolBadge";
            lblRolBadge.Size = new Size(194, 42);
            lblRolBadge.TabIndex = 3;
            lblRolBadge.Text = "ROLA";
            lblRolBadge.TextAlign = ContentAlignment.MiddleCenter;
            //
            // lblEgoeraBadge
            //
            ...
            lblEgoeraBadge.Location = new Point(1522, 71);
            lblEgoeraBadge.Name = "lblEgoeraBadge";
            lblEgoeraBadge.Size = new Size(194, 42);
            lblEgoeraBadge.TabIndex = 4;
            lblEgoeraBadge.Text = "AKTIBOA";
            ...
            lblArgazkiAzalpena.Text = "Argazkia edo identifikazio bisuala.";
            //
            // pnlIdentifikazioa
            //
            ...
            pnlIdentifikazioa.Controls.Add(lblErabiltzaileMotaTitulua);
            pnlIdentifikazioa.Controls.Add(lblErabiltzaileMotaBalioa);
            ...
            //
            // lblErabiltzaileMotaTitulua
            //
            lblErabiltzaileMotaTitulua.Location = new Point(0, 0);
            lblErabiltzaileMotaTitulua.Name = "lblErabiltzaileMotaTitulua";
            lblErabiltzaileMotaTitulua.Size = new Size(100, 23);
            lblErabiltzaileMotaTitulua.TabIndex = 7;
            //
            // lblErabiltzaileMotaBalioa
            //
            lblErabiltzaileMotaBalioa.Location = new Point(0, 0);
            lblErabiltzaileMotaBalioa.Name = "lblErabiltzaileMotaBalioa";
            lblErabiltzaileMotaBalioa.Size = new Size(100, 23);
            lblErabiltzaileMotaBalioa.TabIndex = 8;
            //
            // pnlHarremana
            //
            ...
            // pnlRolPanela
            //
            pnlRolPanela.BackColor = Color.White;
            pnlRolPanela.BorderStyle = BorderStyle.FixedSingle;
            pnlRolPanela.Controls.Add(lblRolDatuak);
            pnlRolPanela.Location = new Point(406, 745);
            pnlRolPanela.Name = "pnlRolPanela";
            pnlRolPanela.Size = new Size(994, 600);
            pnlRolPanela.TabIndex = 4;
            //
            // lblRolDatuak
            //
            lblRolDatuak.Location = new Point(0, 0);
            lblRolDatuak.Name = "lblRolDatuak";
            lblRolDatuak.Size = new Size(100, 23);
            lblRolDatuak.TabIndex = 0;
            //
            // pnlKontua
            //
            pnlKontua.BackColor = Color.White;
            pnlKontua.BorderStyle = BorderStyle.FixedSingle;
            pnlKontua.Controls.Add(lblKontua);
            pnlKontua.Controls.Add(lblIdTitulua);
            pnlKontua.Controls.Add(lblIdBalioa);
            pnlKontua.Controls.Add(lblRolIdTitulua);
            pnlKontua.Controls.Add(lblRolIdBalioa);
            pnlKontua.Controls.Add(lblAltaDataTitulua);
            pnlKontua.Controls.Add(lblAltaDataBalioa);
            pnlKontua.Location = new Point(1406, 745);
            pnlKontua.Name = "pnlKontua";
            pnlKontua.Size = new Size(484, 600);
            pnlKontua.TabIndex = 5;
            //
            // lblKontua
            //
            lblKontua.Location = new Point(0, 0);
            lblKontua.Name = "lblKontua";
            lblKontua.Size = new Size(100, 23);
            lblKontua.TabIndex = 0;
            //
            // lblIdTitulua
            //
            lblIdTitulua.Location = new Point(0, 0);
            lblIdTitulua.Name = "lblIdTitulua";
            lblIdTitulua.Size = new Size(100, 23);
            lblIdTitulua.TabIndex = 1;
            //
            // lblIdBalioa
            //
            lblIdBalioa.Location = new Point(0, 0);
            lblIdBalioa.Name = "lblIdBalioa";
            lblIdBalioa.Size = new Size(100, 23);
            lblIdBalioa.TabIndex = 2;
            //
            // lblRolIdTitulua
            //
            lblRolIdTitulua.Location = new Point(0, 0);
            lblRolIdTitulua.Name = "lblRolIdTitulua";
            lblRolIdTitulua.Size = new Size(100, 23);
            lblRolIdTitulua.TabIndex = 3;
            //
            // lblRolIdBalioa
            //
            lblRolIdBalioa.Location = new Point(0, 0);
            lblRolIdBalioa.Name = "lblRolIdBalioa";
            lblRolIdBalioa.Size = new Size(100, 23);
            lblRolIdBalioa.TabIndex = 4;
            //
            // lblAltaDataTitulua
            //
            lblAltaDataTitulua.Location = new Point(0, 0);
            lblAltaDataTitulua.Name = "lblAltaDataTitulua";
            lblAltaDataTitulua.Size = new Size(100, 23);
            lblAltaDataTitulua.TabIndex = 5;
            //
            // lblAltaDataBalioa
            //
            lblAltaDataBalioa.Location = new Point(0, 0);
            lblAltaDataBalioa.Name = "lblAltaDataBalioa";
            lblAltaDataBalioa.Size = new Size(100, 23);
            lblAltaDataBalioa.TabIndex = 6;
            //
            // NireErabiltzaileFitxa
            //
            AutoScaleDimensions = new SizeF(13F, 32F);
            AutoScaleMode = AutoScaleMode.Font;
            ClientSize = new Size(1902, 1575);
            Name = "NireErabiltzaileFitxa";
            ...
            pnlRolPanela.ResumeLayout(false);
            pnlKontua.ResumeLayout(false);
            ResumeLayout(false);
        }
        ...
        private static void KonfiguratuSectionTitle(Label label, string testua, int x)
        {
            ...
            label.ForeColor = Color.FromArgb(77, 102, 126);
            label.Location = new Point(x, 22);
            label.Size = new Size(360, 30);
            label.Text = testua;
        }
        ...
        private static void KonfiguratuField(Label label, string testua, int x, int y)
        {
            ...
            label.ForeColor = Color.FromArgb(112, 127, 143);
        ...
        private static void KonfiguratuValue(Label label, string testua, int x, int y, int zabalera)
        {
            ...
            label.ForeColor = Color.FromArgb(30, 49, 69);
            label.Location = new Point(x, y);
            label.Size = new Size(zabalera, 52);
            label.Text = testua;
        }
        ...
        private Label lblErabiltzaileMotaTitulua;
        private Label lblErabiltzaileMotaBalioa;
        ...
        private Panel pnlRolPanela;
        private Label lblRolDatuak;
        private Panel pnlKontua;
        private Label lblKontua;
        private Label lblIdTitulua;
        private Label lblIdBalioa;
        private Label lblRolIdTitulua;
        private Label lblRolIdBalioa;
        private Label lblAltaDataTitulua;
        private Label lblAltaDataBalioa;
    }
}