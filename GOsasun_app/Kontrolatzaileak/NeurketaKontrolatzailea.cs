...
namespace GOsasun_app.Kontrolatzaileak
{
    ...
    public class NeurketaKontrolatzailea
    {
        ...
        /// </summary>
        /// <param name="pazienteId">Pazientearen IDa.</param>
        /// <returns>Neurketa objektuen zerrenda.</returns>
        ...
        /// </summary>
        /// <param name="neurketa">Gorde beharreko neurketa.</param>
        /// <returns>Arrakasta bada true, bestela false.</returns>
